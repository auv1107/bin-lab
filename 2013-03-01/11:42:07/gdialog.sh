...
if [ $? != 0 ]
then
	gdialog --msgbox "Thank you anyway!" 10 20
	sleep 2
	gdialog --clear
	exit 0
fi
gdialog --title "Questionnaire" --inputbox "Input your name" 9 30 2>_1.txt
Q_NAME=$(cat _1.txt)
gdialog --menu "$Q_NAME, what music do you prefer?" 15 30 4 1 "Classical" 2 "Jazz" 3 "Country" 4 "Other" 2>_1.txt
Q_MUSIC=$(cat _1.txt)
if [ $Q_MUSIC -eq 1 ]
then
